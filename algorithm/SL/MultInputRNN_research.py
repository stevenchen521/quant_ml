    ...
    def train(self):
        for step in range(self.train_steps):
            ...
            if (step + 1) % 1000 == 0:
                ...
                logging.warning("Step: {0} |train_loss: {1:.7f} |Test_Loss: {2:.7f}".format(step + 1, loss, loss_test))
...
def main(args):
    ...
    col_order = ['open', 'high', 'low', 'close', 'volume',
                 'stoch_14_3_0_3_0_0', 'stoch_14_3_0_3_0_1', 'trend_backward|close|10_5_10', 'rsi|close|14', 'roc|close|20', 'tp_score',
                    'on', '6m',
                  'nasvolume', 'nasclose', 'trend_backward|nasclose|10_5_10', 'trend|close|10_5_10']
    ...
    Index(['open', 'high', 'low', 'close', 'volume', 'on', '6m', 'nasclose',
          ...
          dtype='object')
    '''
    env = Market(codes, start_date="2008-01-01", end_date="2019-03-08",
                 col_order=col_order,
                 **{
        "market": market,
        "use_sequence": True,
    ...
    algorithm = Algorithm(tf.Session(config=config), env, env.seq_length, env.data_dim, [5, 6, 2, 3], env.code_count, **{
        "mode": mode,
        "layer_size": 1,
        "hidden_size": 16,
