...
def handle_bar(context, bar_dict):
    ...
    for stock in context.stocks:
        ...
        # 当RSI大于设置的上限阀值，清仓该股票
        if rsi_data_last_day < context.HIGH_RSI and rsi_data_today > context.HIGH_RSI and cur_position > 0:
            order_target_value(stock, 0)

        # 当RSI小于设置的下限阀值，用剩余cash的一定比例补仓该股
        if rsi_data_last_day > context.LOW_RSI and rsi_data_today < context.LOW_RSI:
